...
const Footer = () => {
    return (
        <footer className="w-full max-w-[85vw] py-12 px-4 sm:px-6 lg:px-8 mx-auto ">
            {/* Footer */}
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4  gap-6 mb-10">
                <div className="col-span-full  lg:col-span-1 lg:block">

                    <Link href="/" className="text-2xl ">MiniStore</Link>


                    <p className="mt-3 text-xs sm:text-sm text-gray-900 dark:text-black">
                ...
                <div>
                    <h4 className="text-xs font-semibold text-yellow-500 uppercase dark:text-black">
                        Quick Links
                    </h4>
                ...
                <div>
                    <h4 className="text-xs font-semibold text-gray-900 uppercase dark:text-black">
                        Help & Info
                    </h4>
            ...
            <div className=" pt-5 mt-5 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="grid grid-cols-3 items-center justify-between ">
                    ...
                    <div className="space-x-4">
                        <p className="text-xs">We ship with:</p>
                        <a
                            className="inline-block text-gray-500 hover:text-[#72AEC8] dark:hover:text-[#72AEC8]"
                            href="#"
                        >
                    ...
                    <p className="mt-1 text-xs sm:text-sm text-gray-900 dark:text-black">
